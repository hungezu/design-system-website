# AI 使用规则（guokexin · v1.5.0）

- 项目：guokexin（projectId: proj-mtwba7n6-nh1d88）
- 发布版本：1.5.0（schema bds-release/3；整包 checksum 见 manifest.json）
...
8. 只使用当前 projectId（proj-mtwba7n6-nh1d88）与 releaseVersion（1.5.0）的资产；切换项目 / 版本必须显式加载对应发布包。
