# AI 使用规则（test-customer-b · v1.2.1）

- 项目：test-customer-b（projectId: proj-mtwbe3v9-zf5v8f）
- 发布版本：1.2.1（schema bds-release/2；整包 checksum 见 manifest.json）
...
8. 只使用当前 projectId（proj-mtwbe3v9-zf5v8f）与 releaseVersion（1.2.1）的资产；切换项目 / 版本必须显式加载对应发布包。
